...
cols=["Measure","variable","DLD_M_SD","HI_M_SD","Control_M_SD","KW_H","KW_p","KW_p_holm15",
...
with open(f"{RESULTS}/run_log.md","a",encoding="utf-8") as f:
    ...
    f.write(f"- Table 1 (demographics) + Table 2 (15 measures: Kruskal-Wallis, Holm across 15; Dunn's pairwise, Holm within measure)\n")
